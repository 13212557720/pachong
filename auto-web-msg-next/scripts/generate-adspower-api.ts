...
const OPENAPI_FILE_SOURCE = 'scripts/AdsPower API Document.openapi.json'
const OUTPUT_DIR = path.resolve(process.cwd(), 'src/lib/adspower-api/generated')
...
function createModuleFileContent(
  ...
  const clientImportPath = isAdsPower ? '../client' : '@/api/client'
